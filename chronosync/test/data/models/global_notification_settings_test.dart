  ...
  group('GlobalNotificationSettings', () {
    test('defaults factory creates expected settings', () {
      final GlobalNotificationSettings settings =
          GlobalNotificationSettings.defaults();
    ...
    test('copyWith updates only specified fields', () {
      final GlobalNotificationSettings original =
          GlobalNotificationSettings.defaults();
    ...
    test('equality works correctly', () {
      final GlobalNotificationSettings settings1 =
          GlobalNotificationSettings.defaults();
      final GlobalNotificationSettings settings2 =
          GlobalNotificationSettings.defaults();
      final GlobalNotificationSettings settings3 = settings1.copyWith(
        notificationsEnabled: false,
      );
