...
class MockSeriesRepository extends _i1.Mock implements _i2.SeriesRepository {
  ...
  @override
  _i3.Future<void> addSeries(_i4.Series? series) => (super.noSuchMethod(
        Invocation.method(
          #addSeries,
          [series],
        ),
  ...
  @override
  _i3.Future<void> deleteSeries(int? key) => (super.noSuchMethod(
        Invocation.method(
          #deleteSeries,
          [key],
        ),
  ...
  @override
  List<_i4.Series> getAllSeries() => (super.noSuchMethod(
        Invocation.method(
          #getAllSeries,
          [],
        ),
  ...
  @override
  _i3.Future<void> addEventToSeries(
    int? seriesKey,
    _i5.Event? event,
  ) =>
      (super.noSuchMethod(
