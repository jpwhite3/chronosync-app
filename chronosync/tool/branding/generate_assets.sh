...
icon_background="#050608"
launch_background_light="#F4F5FA"
launch_background_dark="#050608"
...
render_icon 48 "android/app/src/main/res/mipmap-mdpi/ic_launcher.png"
render_icon 72 "android/app/src/main/res/mipmap-hdpi/ic_launcher.png"
render_icon 96 "android/app/src/main/res/mipmap-xhdpi/ic_launcher.png"
render_icon 144 "android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png"
render_icon 192 "android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png"

windows_icon="$output_root/windows/runner/resources/app_icon.ico"
mkdir -p "$(dirname "$windows_icon")"
magick "$temp_dir/icon.png" \
  -define icon:auto-resize=256,128,96,64,48,32,24,16 \
  "$windows_icon"

launch_dir="ios/Runner/Assets.xcassets/LaunchImage.imageset"
render_launch_image 168 185 168 "$launch_background_light" \
  "$launch_dir/LaunchImage.png"
render_launch_image 336 370 336 "$launch_background_light" \
  "$launch_dir/LaunchImage@2x.png"
render_launch_image 504 555 504 "$launch_background_light" \
  "$launch_dir/LaunchImage@3x.png"
render_launch_image 168 185 168 "$launch_background_dark" \
  "$launch_dir/LaunchImage-dark.png"
render_launch_image 336 370 336 "$launch_background_dark" \
  "$launch_dir/LaunchImage-dark@2x.png"
render_launch_image 504 555 504 "$launch_background_dark" \
  "$launch_dir/LaunchImage-dark@3x.png"
